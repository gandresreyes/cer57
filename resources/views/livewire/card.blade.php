        ...
        <div class="flex flex-col items-center md:flex-row ">
            <div class="w-full mt-16 md:mt-0 md:w-2/5  ">
                <div class=" relative z-10 h-auto p-8 py-8 overflow-hidden bg-white  border-gray-300 rounded-lg shadow-2xl px-7 text-center">                      
                    ...
                    <p class="px-4 pt-5"> Total a Pagar $<span  class=" font-bold valortotal" id="total"></span></p>          
                    <div class="relative">                        
            ...
            <div class="w-full   md:w-3/5  mt-5 md:ml-5 md:mt-0 bg-black bg-opacity-70 p-5  rounded-lg">                
                ...
                <p class="text-xl  md:pr-16 text-white ">Learn how to engage with your visitors and teach them about your mission. We're revolutionizing the way customers and businesses interact.</p>
                 
            </div>        
        </div>
    </div>
</section>
<a href="https://web.whatsapp.com/?send=+57300000000" class=" rounded-full text-white bg-green-400 p-2 fixed bottom-16  right-2 z-50 focus:outline-none hover:bg-green-700  pulse"> 
